...
when 'ubuntu'
    ...
    when '10.04', '12.04', '14.04' , '16.04'
        package 'lsb-release' do
            action :install
        end
        include_recipe 'teagent::repository'
    else
        Chef::Application.fatal!('Only Ubuntu 10.4 (lucid), 12.04 (precise), 14.04(trusty) and 16.04 (xenial) are supported. Please contact support.')
    end
